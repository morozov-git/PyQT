...
if __name__ == '__main__':
    ...
    test_db.user_login('TestSender1', '192.168.0.74', 8888)
    test_db.user_login('TestSender2', '192.168.0.74', 8888)
    # выводим список кортежей - активных пользователей
    print(test_db.active_users_list())
    # выполянем 'отключение' пользователя
    test_db.user_logout('TestSender1')
    # выводим список активных пользователей
    print(test_db.active_users_list())
    # запрашиваем историю входов по пользователю
    test_db.login_history('TestSender1')
    # выводим список известных пользователей
    print(test_db.users_list())
    print(test_db.active_users_list())
    test_db.user_logout('TestSender2')
    print(test_db.login_history('re'))
    test_db.add_contact('TestSender1', 'TestSender2')
    test_db.add_contact('TestSender2', 'TestSender1')
    test_db.remove_contact('TestSender1', 'TestSender2')
    # test_db.process_message('TestSender1', 'TestSender2')
