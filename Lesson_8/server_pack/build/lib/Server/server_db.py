""" SQL Alchemy. настройка базы данных сервера. """
...
if __name__ == '__main__':
	...
	test_db.add_user('test1', 'hash')
	test_db.user_login('test1', '192.168.0.50', 8888, 'key')
	test_db.user_login('test1', '192.168.0.50', 8888, 'key')
	test_db.user_login('test2', '192.168.1.113', 8081, 'key')
