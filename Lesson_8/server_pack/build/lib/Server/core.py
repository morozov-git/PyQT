""" Транспорт сервера. Обработчик сообщений поступающих от клиентов. """
...
from server_pack.common.loging_decos import login_required
...
class MessageProcessor(threading.Thread):
	...
	# Вызов дескрипторов для проверки введенных данных
	port = Port()
