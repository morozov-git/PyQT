""" PyQT интерфейс. Главное окно клиента. """
...
from client_pack.Client.main_window_conv import Ui_MainClientWindow
from client_pack.Client.add_contact import AddContactDialog
from client_pack.Client.del_contact import DelContactDialog
...
class ClientMainWindow(QMainWindow):
	...
	def message(self, message):
		""" Слот обработчик поступаемых сообщений, выполняет дешифровку поступаемых сообщений и их сохранение
		в истории сообщений. Запрашивает пользователя если пришло сообщение не от текущего собеседника.
